...
JSON::Schema::Modern::Document::OpenAPI - One JSON Schema document
...
Bugs may be submitted through L<the RT bug tracker|https://rt.cpan.org/Public/Dist/Display.html?Name=JSON-Schema-Modern-Document-OpenAPI>
(or L<bug-JSON-Schema-Modern-Document-OpenAPI@rt.cpan.org|mailto:bug-JSON-Schema-Modern-Document-OpenAPI@rt.cpan.org>).
